...
(function(window) {
    ...
    Placeholder.extend({
        ...
        initialize : function() {
             ...
             */
            if (!config.carrier.placeholder && !config.carrier.getAttributeNode('placeholder').nodeValue) {
    ...
    function Main() {
        ...
        this._.placeholder = config.carrier.placeholder || config.carrier.getAttributeNode('placeholder').nodeValue;
